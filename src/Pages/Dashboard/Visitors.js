...
function Track(props) {
    ...
    useEffect(() => {
        socket.on("info", function (obj) {
            ...
            setDevice(
                (obj.data.os.name || "") + " " + (obj.data.os.version || "")
            );
            setBrowser(
                (obj.data.browser.name || "") +
                    " v" +
                    (obj.data.browser.version || "")
            );
                            ...
                            >
                                ...
                                >
                                    <Avatar
                                        ...
                                        variant="rounded"
                                        onClick={() => {
                                            editVisitor(visitor.visitor_id);
                                        }}
                                    >
                                        <EditIcon />
                                    </Avatar>
    ...
    const trackUser = (id) => {
        return (
            <div className="page">
                {Object.entries(visitor).length !== 0 ? (
                    <Paper className="visitor" variant="outlined">
                        <Badge
                            badgeContent=" "
                            color={
